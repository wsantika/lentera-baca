# Graph Report - lentera-baca  (2026-07-28)

## Corpus Check
- 73 files · ~21,509 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 505 nodes · 603 edges · 41 communities (33 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c0c74fd`
...
7. `include` - 7 edges
8. `5. Main Features` - 7 edges
9. `📊 Database Schema — Lentera Baca V2` - 7 edges
10. `Page-Specific QA` - 7 edges
...
### Community 0 - "cn"
Cohesion: 0.05
Nodes (41): LearningStatePreview(), textSizeLabels, textSizeOrder, PageContainer(), PageContainerProps, clampPercentage(), getInitials(), ModeButton() (+33 more)
...
Cohesion: 0.18
Nodes (16): addUniqueItem(), defaultSettings, defaultState, getTodayKey(), getYesterdayKey(), LearningMode, LearningSettings, LearningState (+8 more)
...
- **Why does `cn()` connect `cn` to `layout.tsx`, `leaderboard-page-content.tsx`?**
